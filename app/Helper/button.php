...
function btn_delete_submit($msg = null)
{
    return "<button class='btn btn-danger btn-xs delete-swl' data-msg='". (isset($msg) ? $msg : '') ."' data-toggle='tooltip' data-placement='top' title='" . trans('common.delete') . "'><i class='fa fa-trash-o'></i></button>";
}
