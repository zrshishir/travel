<div class="form-group {{ $errors->hasAny('facebook_client_id') ? ' has-error' : '' }}">
...
<div class="form-group {{ $errors->hasAny('facebook_client_secret') ? ' has-error' : '' }}">
...
<div class="form-group {{ $errors->hasAny('facebook_redirect') ? ' has-error' : '' }}">
