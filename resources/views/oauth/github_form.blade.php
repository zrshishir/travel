    ...
    <div class="form-group {{ $errors->hasAny('github_client_id') ? ' has-error' : '' }}">
    ...
    <div class="form-group {{ $errors->hasAny('github_client_secret') ? ' has-error' : '' }}">
    ...
    <div class="form-group {{ $errors->hasAny('github_redirect') ? ' has-error' : '' }}">
