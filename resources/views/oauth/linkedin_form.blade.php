<div class="form-group {{ $errors->hasAny('linkedin_client_id') ? ' has-error' : '' }}">
...
<div class="form-group {{ $errors->hasAny('linkedin_client_secret') ? ' has-error' : '' }}">
...
<div class="form-group {{ $errors->hasAny('linkedin_redirect') ? ' has-error' : '' }}">
