<div class="form-group {{ $errors->hasAny('twitter_client_id') ? ' has-error' : '' }}">
...
<div class="form-group {{ $errors->hasAny('twitter_client_secret') ? ' has-error' : '' }}">
...
<div class="form-group {{ $errors->hasAny('twitter_redirect') ? ' has-error' : '' }}">
