<div class="form-group {{ $errors->hasAny('google_client_id') ? ' has-error' : '' }}">
...
<div class="form-group {{ $errors->hasAny('google_client_secret') ? ' has-error' : '' }}">
...
<div class="form-group {{ $errors->hasAny('google_redirect') ? ' has-error' : '' }}">
