...
<head>
    <meta charset="UTF-8">
    <title> HR Request | Installation </title>
        ...
        <div class="col-md-8 col-md-offset-2" style=" padding-top: 10px;">
            <div class="panel panel-primary room">
                ...
                <div class="panel-body" id="database">
                    ...
                    <h4 class="text-center">Database Configuration & Cron Job Settings</h4>
                    <hr style="margin: 0px"/>
                    ...
                    <form action="{{  url('install/store') }}" method="POST">
                        ...
                        <div class="form-group ">
                            <label for="username" class="col-md-3 control-label text-right">Database Username</label>
                        ...
                        <div class="form-group ">
                            <label for="password" class="col-md-3 control-label text-right">Database Password</label>
                ...
                <div class="panel-footer"><a target="_blank" href="http://www.zrshishir.com" style="color: #333"> ©
                        zrshishir</a>
                </div>
            </div>
...
<script>
    $(function () {
        ...
        @elseif(Session::has('extensions_error'))
            $('#folders').addClass('hidden');
