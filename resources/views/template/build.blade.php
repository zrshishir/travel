...
<topbar>
    ...
    <div class="left">
        @if(!isset($template))
            {!! Form::open(['url' => "template", 'novalidate' => 'novalidate', 'class' => 'ajax_upload_form form-validate-jquery', 'id'=>'template', 'role' => 'form', 'data-toggle' => 'form-ajax', 'data-url' => 'No', 'files' => true]) !!}
        @else
